...
void LinkedList<T>::insertOrdered(const T& newData) {
 ...
 //std::cout << "Copy of Linked List: " << *this << std::endl;
 //std::cout << "New data to be inserted: " << newData << std::endl;
 //std::cout << "Size of Linked List: " << this->size() << std::endl;
 ...
 else if(this->front() > newData)
 {
   this->pushFront(newData);
 }
 else if(this->back() < newData)
 {
 ...
 else
 {
    ...
    while(!this->empty())
    {
         //Traverse the list and find spot to insert new data in
        ...
        {
          //std::cout << "Insert between " << prevNode->data << " and " << currNode->data << std::endl; 
          //Create new Node and insert it to the list
          Node* newNode = new Node(newData);

          newNode->data = newData;
          
          //Point new Node to the prev and current Node
 ...
 //std::cout << "New Linked list copy: " << *this << std::endl;
 //std::cout << "New Size of Linked List: " << this->size() << std::endl;
 //std::cout << "" << std::endl;
...
LinkedList<T> LinkedList<T>::merge(const LinkedList<T>& other) const {
  ...
  //    very slow.
   ...
   //Placeholders for left list Nodes starting at the Head/First Entry
   Node currLeft;
   Node prevLeft;

   //Placeholder for right list Nodes starting at the Head/First Entry
   Node currRight;

   std::cout << "Current Left Node Data: " << currLeft.data << std::endl;
   std::cout << "Current Right Node Data: " << currRight.data << std::endl;
   std::cout << "" << std::endl;
 
//TODO: Need to fix sorting algorithm. Almost there
  
  while(!left.empty() && !right.empty())
  {

        currLeft = left.front();
        currRight = right.front();

      if(currRight.data < currLeft.data)
      {
        merged.pushBack(currRight.data);
        right.popFront();      
        
      }
      else
      {
          merged.pushBack(currLeft.data);
          left.popFront(); 
    ...
    //std::cout << "Updated Left List: " << merged << std::endl;
    //std::cout << "Current Left Node Data: " << currLeft.data << std::endl;
    //std::cout << "Current Right Node Data: " << currRight.data << std::endl;
    //std::cout << "" << std::endl;
  }
